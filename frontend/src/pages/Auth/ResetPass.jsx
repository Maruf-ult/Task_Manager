...
const ResetPass = () => {
 ...
 return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      <h1 className="absolute right-4 sm:right-20 top-5 font-bold text-xl sm:text-3xl md:text-4xl">Task Manager</h1>

  {!isEmailSent && (
        <form onSubmit={onSubmitEmail} className="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-sm sm:w-96 text-sm mx-4">
      ...
      {!isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitOtp} className="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-sm sm:w-96 text-sm mx-4">
          ...
          <div className="flex justify-between gap-1 sm:gap-2 mb-8">
            {Array(6)
              ...
              .map((_, index) => (
                <input
                  className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-200 text-black text-center text-lg sm:text-xl rounded-md border border-gray-300"
                  type="text"
                  maxLength="1"
                  key={index}
                  required
      ...
      {isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitNewPassword} className="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-sm sm:w-96 text-sm mx-4">
